...
```{r}
cat("Individuals Affected - All\n")
summary(breach_df$Individuals.Affected)

cat("Individuals Affected -")
...
plot_ly(breach_df, y=na.omit(breach_df$Individuals.Affected.Normalized.Outliers), type='box', name='Only Whiskers', boxpoints = FALSE) %>%
...
--- 
```{r}
plot_ly(x = na.omit(breach_df$Individuals.Affected.Normalized.Outliers), type = "histogram",  histnorm = "probability") %>%
